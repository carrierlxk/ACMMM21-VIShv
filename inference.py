...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='E:\PythonProjects\STEm-Seg-data\stemsegmodels'
                                                          '\checkpoints\ytvis\ytvis_v9\glow_youtube_151_v9_2.12\\210000.pth')

    # parser.add_argument('--output_dir', '-o',              required=False)
    parser.add_argument('--output_dir', '-o', type=str, default='E:\PythonProjects\STEm-Seg-data\output\ytvis\ytvis_v9\debug')
